...
public class IndexFragmentPresenter extends ABSVerifyNeedPresenter implements IApiRequestPresenter,
    ...
    public void onItemClick(int position) {
        DLog.i(getClass(),"link:"+bannerResBeans.get(position).getLink());
//        if (bannerResBeans.get(position).getLink().equals(IPublicConst.APP_COMMENT_ACTIVITY)) {
//            Intent intent = new Intent(iIndexFragment.getActivity(), StaticPromoteActivity.class);
    ...
    private class RecommendTaskListModelCallback implements
        ...
        public void onSuccess(BaseBeanContainer<ArrayList<RecommendTaskResBean>> beanContainer) {
            ...
            if (isRefreshOperate) {
                ...
                iIndexFragment.addRecommentListItems(liData);
            }
