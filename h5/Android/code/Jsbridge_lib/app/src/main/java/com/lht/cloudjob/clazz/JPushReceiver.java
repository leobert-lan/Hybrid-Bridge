...
import com.lht.cloudjob.test.TestJpushActivity;
...
public class JPushReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		DLog.d(getClass(), "[MyReceiver] onReceive - " + intent.getAction() + ", extras: " + printBundle(bundle));
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
			...
			DLog.d(getClass(), "[MyReceiver] 接收到推送下来的通知的ID: " + notifactionId);
