 ...
 * <p><b>Classname</b> EAuthenticModel
...
public class EAuthenticModel implements IApiRequestModel {

    private final ApiModelCallback<BaseVsoApiResBean> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.EAuthenticate api;

    private RequestParams params;

    private RequestHandle handle;

    public EAuthenticModel(EAUModelBean bean, ApiModelCallback<BaseVsoApiResBean> callback) {
        this.modelCallback = callback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.EAuthenticate();
