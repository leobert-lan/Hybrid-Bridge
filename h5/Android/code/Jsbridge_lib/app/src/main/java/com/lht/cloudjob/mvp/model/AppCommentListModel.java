 ...
 * <p><b>Classname</b> AppCommentListModel
 * <p><b>Description</b>: TODO
 * <p>Created by leobert on 2016/11/15.
 */
@TempVersion(TempVersionEnum.V1019)
public class AppCommentListModel implements IPagedApiRequestModel {
    private final ApiModelCallback<ArrayList<AppCommentResBean>> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.AppCommentListApi api;
    ...
    public AppCommentListModel(ApiModelCallback<ArrayList<AppCommentResBean>> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.AppCommentListApi();
    }
    ...
    public void doRequest(Context context) {
        ...
        composite.addHandler(new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (bean.isSuccess()) {
                    ArrayList<AppCommentResBean> data =
                            (ArrayList<AppCommentResBean>) JSON.parseArray(bean.getData(),
                                    AppCommentResBean.class);
