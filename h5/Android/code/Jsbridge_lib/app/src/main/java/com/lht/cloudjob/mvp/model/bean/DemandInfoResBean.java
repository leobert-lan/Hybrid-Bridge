...
public class DemandInfoResBean {
    ...
    public String getPriceString() {
        ...
        String _p = new DecimalFormat("0.00").format(getTask_cash());
    ...
    public void setMin_cash(float min_cash) {
    ...
    public void setMax_cash(float max_cash) {
        this.max_cash = max_cash;
    }

    public float getReal_cash() {
        return real_cash;
    }

    public void setReal_cash(float real_cash) {
