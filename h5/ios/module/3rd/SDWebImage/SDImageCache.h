...
typedef NS_ENUM(NSInteger, SDImageCacheType) {
    /**
     * The image wasn't available the SDWebImage caches, but was downloaded from the web. 0
     */
    SDImageCacheTypeNone,
    /**
     * The image was obtained from the disk cache. 1
     */
    SDImageCacheTypeDisk,
    /**
     * The image was obtained from the memory cache. 2
     */
